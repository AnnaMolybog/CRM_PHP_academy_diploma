 ...
 */
class Version20160830113938 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE schema_role DROP sequence');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Schema_Role ADD sequence INT NOT NULL');
    }
}
